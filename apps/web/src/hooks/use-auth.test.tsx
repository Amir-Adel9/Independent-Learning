...
const getApiClient = () =>
  import('@/api/client').then(
    (m) => m.apiClient as unknown as { POST: ReturnType<typeof vi.fn>; GET: ReturnType<typeof vi.fn> },
  );
...
describe('useAuth', () => {
  ...
  describe('login', () => {
    ...
    it('on error calls toast.error with extracted message', async () => {
      ...
      api.POST.mockRejectedValueOnce(
        Object.assign(new Error('401'), { response: res }),
      );
  ...
  describe('register', () => {
    ...
    it('on error calls toast.error with extracted message', async () => {
      ...
      api.POST.mockRejectedValueOnce(
        Object.assign(new Error('409'), { response: res }),
      );
